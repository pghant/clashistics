    ...
    return (
        <nav
            ...
            <div className="flex w-full flex-wrap items-center justify-between px-3">
                ...
                <div
                    className={`${showNav ? '' : 'hidden'} mt-2 flex-grow basis-[100%] items-center md:mt-0 md:flex md:basis-auto`}>
